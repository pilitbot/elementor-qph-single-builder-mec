...
class ESB_Next_Pervious extends ESB_Base {
    public function get_name() { return 'qph-esb-next-pervious'; }
    public function get_title() { return __('MEC Next/Previous', 'elementor-qph-single-builder-mec'); }
